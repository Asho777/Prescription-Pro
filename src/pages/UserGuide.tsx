          ...
          <div className="prose max-w-none">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">Getting Started</h2>
              ...
              <p className="text-red-800 font-medium">
                <strong>Please Note!</strong> First thing to do is to add your Doctors and your Pharmacies in 
								their respective sections first. Both the Doctor and the Pharmacy are required, to be able to proceed 
								with the completion of all your Medications.
              </p>
            </div>
