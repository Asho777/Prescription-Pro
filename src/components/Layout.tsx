  ...
  return (
    <div className={`min-h-screen ${isDark ? 'bg-gray-900' : 'bg-gray-50'}`}>
        ...
        <div className={`fixed inset-y-0 left-0 flex w-64 flex-col shadow-xl ${isDark ? 'bg-gray-800' : 'bg-white'}`}>
          <div className="flex h-16 items-center justify-between px-4">
            <div className="flex items-center">
              ...
              <span className={`ml-2 text-xl font-bold ${isDark ? 'text-white' : 'text-gray-900'}`}>Prescription Pro</span>
            </div>
            <button
      ...
      <div className="lg:pl-64">
        {/* Top bar */}
        <div className={`sticky top-0 z-40 flex h-16 shrink-0 items-center gap-x-4 border-b px-4 shadow-sm sm:gap-x-6 sm:px-6 lg:px-8 ${isDark ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'
          }`}>
          <button
            type="button"
